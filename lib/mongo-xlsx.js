...
exports.mongoToExcel = function(mongoData, mongoModel, callback) {
  var excel = [[]];
  var index;
...
exports.excelToMongo = function(excelData, mongoModel, callback) {
  var headers = [];
  var mongoData = [];
  var headersOffset = 1;
